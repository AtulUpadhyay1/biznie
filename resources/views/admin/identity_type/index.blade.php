                ...
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="bz-toolbar">
                        <form class="custom-search-bar">
                            <label class="bz-filter-label" for="identity_type_search">Search identity types</label>
                            <div class="input-group">
                                <span class="input-group-text"> <i class="bi bi-search"></i></span>
                                <input type="text" id="identity_type_search" class="form-control" placeholder="Search here...">
                            </div>
                        </form>
                        <a type="button" class="btn btn-danger btn-sm"
                            title="add" href="{{ route('admin.create-identity-type') }}" wire:navigate>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="ActionBtn_{{ $data->id }}">
                                                ...
                                                <a href="{{route('admin.edit-identity-type', $data->id)}}"
