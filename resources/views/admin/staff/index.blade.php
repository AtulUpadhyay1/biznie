                    ...
                    <div class="bz-toolbar">
                        <form class="custom-search-bar">
                            <div class="input-group">
                                ...
                                <label class="bz-filter-label" for="staff_search">Search</label>
                                <input id="staff_search" type="text" class="form-control" placeholder="Search here...">
                            </div>
                        </form>
                        <a type="button" class="btn btn-danger btn-sm"
                            title="add" href="{{ route('admin.staff.create') }}" wire:navigate>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="ActionBtn_{{ $data->id }}">
                                                <a href="{{route('admin.staff.edit', $data->id)}}"
