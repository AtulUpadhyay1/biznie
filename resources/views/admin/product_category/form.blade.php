                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4 border-start">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label" for="product_category_thumbnail">Thumbnail Image <span
                                                class="text-danger">*</span></label>
                                        <input type='file' id="product_category_thumbnail"
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label" for="product_category_banner">Banner Image <span
                                                class="text-danger">*</span></label>
                                        <input type='file' id="product_category_banner"
