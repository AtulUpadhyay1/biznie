                    ...
                    <form class="forms-sample" wire:submit.prevent="{{$hidden_id ? 'update()' : 'save()'}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type='file' id="product_category_thumbnail" class="form-control" wire:model.defer="thumbnail">
                        ...
                        <div class="row mb-3 mb-md-0">
                            <div class="col-md-6">
                                ...
                                <input type='file' id="product_category_banner" class="form-control mb-3 mb-md-0" wire:model.defer="banner">
