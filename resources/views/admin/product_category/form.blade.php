                    ...
                    <form class="forms-sample" wire:submit.prevent="{{$hidden_id ? 'update()' : 'save()'}}">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                    ...
                                    <select class="form-select mb-4 mb-md-0 @error('business_category_id') is-invalid @enderror" id="business-product-category"  wire:model.defer="business_category_id">
