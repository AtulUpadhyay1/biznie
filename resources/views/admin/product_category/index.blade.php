                ...
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="bz-toolbar">
                        ...
                        @can('commodity_product-create')
                            <a type="button" class="btn btn-danger btn-sm" title="add" href="{{route('admin.create-product-category')}}" wire:navigate>
                                <i class="bi bi-plus-lg"></i>Add Product Category
                            </a>
                        @endcan
                    </div>
                </div>
