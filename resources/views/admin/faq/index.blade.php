                ...
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="bz-toolbar">
                        <form class="custom-search-bar">
                            <label class="bz-filter-label" for="faq_search">Search FAQs</label>
                            <div class="input-group">
                                <span class="input-group-text"> <i class="bi bi-search"></i></span>
                                <input type="text" id="faq_search" class="form-control" placeholder="Search here..."
                                    wire:model.live.debounce.400ms="search">
                            </div>
                        </form>
                        <a type="button" class="btn btn-danger btn-sm"
                            title="add" href="{{ route('admin.faq.create') }}" wire:navigate>
