            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="bz-toolbar">
                        <a href="{{route('admin.credit-wallet-document-type.create')}}" class="btn btn-danger btn-sm" wire:navigate><i class="bi bi-plus-lg"></i>Add</a>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="ActionBtn_{{$data->id}}">
                                                <a href="javascript:;" class="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#exampleModal_{{$data->id}}"><i class="bi bi-eye me-2"></i><span>Show</span></a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel_{{$data->id}}">{{ $data->name }}</h5>
