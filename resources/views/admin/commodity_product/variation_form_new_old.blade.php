                ...
                <form wire:submit.prevent="save()">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        @foreach ($selected_attributes as $attribute)
                                            <th class="text-center">
                                                ...
                                                <select class="form-select form-select-sm text-center" wire:model="unit.{{getAttribute($attribute)->name}}">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($variation_inputs as $variation_key => $variation_input)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-md-1">
                                                    <button type="button" class="btn btn-sm btn-inverse-danger btn-icon" wire:click="removeVariationField({{$variation_key}})" title="Remove Field"><i class="bi bi-x-circle"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                            ...
                            <div>
                                <button type="button" class="btn btn-sm btn-inverse-success" wire:click="addVariationField({{$variation_count}}, false)" title="Add Field"><i class="bi bi-plus-lg"></i>Add More</button>
                            </div>
                        </div>
