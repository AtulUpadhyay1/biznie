                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="ActionBtn{{$data->id}}">
                                                ...
                                                <a class="dropdown-item d-flex align-items-center" href="{{route('admin.commodity-product.statePrice', $data->id)}}" wire:navigate><i class="bi bi-geo-alt icon-sm me-2"></i><span>Update State Price</span></a>
