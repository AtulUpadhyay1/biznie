                        ...
                        <div class="accordion mt-2" id="product_quality">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="product_quality">
                                    <button class="accordion-button collapsed fw-bold fs-5" type="button" data-bs-toggle="collapse" data-bs-target="#product_quality_collapse"
                                    aria-expanded="false" aria-controls="product_quality_collapse">
                                    Product Quality
                                    </button>
                                </h2>
                                <div id="product_quality_collapse" class="accordion-collapse collapse" aria-labelledby="product_quality"
                                    data-bs-parent="#product_quality">
                        ...
                        <div class="accordion mt-2" id="product_variation_accordion">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="product_variation_heading">
                                    <button class="accordion-button collapsed fw-bold fs-5" type="button" data-bs-toggle="collapse" data-bs-target="#product_variation_collapse" aria-expanded="false" aria-controls="product_variation_collapse">
                                        Product Variation
                                    </button>
                                </h2>
                                <div id="product_variation_collapse" class="accordion-collapse collapse" aria-labelledby="product_variation_heading" data-bs-parent="#product_variation_accordion">
                                    <div class="accordion-body">
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                <thead>
                            ...
                            @foreach ($data->getStateVariation as $state_variation)
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading_{{ $state_variation->id }}">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#state_variation_collapse_{{ $state_variation->id }}" aria-expanded="false" aria-controls="state_variation_collapse_{{ $state_variation->id }}">
