                            ...
                            <div class="card">
                                ...
                                <form wire:submit.prevent="save()">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-10"><label class="form-label" for="document">Document</label></div>
                                                <div class="col-2 text-end"><a href="{{asset(imageUrl($data->document))}}" target="_blank">View</a></div>
                                            </div>
