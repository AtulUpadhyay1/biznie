                        ...
                        <div class="row mb-3">
                            <div class="col-md-8 border-end">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('product_category_id') is-invalid @enderror" id="business-product-category"  wire:model="product_category_id" wire:change="setProductSubCategoryList()">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('product_sub_category_id') is-invalid @enderror" id="product-sub-category" wire:model="product_sub_category_id">
                            ...
                            <div class="col-md-4 border-start">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label" for="product_subsubcategory_thumbnail">Thumbnail Image</label>
                                        <input type='file' id="product_subsubcategory_thumbnail" class="form-control @error('thumbnail') is-invalid @enderror" wire:model="thumbnail">
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label" for="product_subsubcategory_banner">Banner Image</label>
                                        <input type='file' id="product_subsubcategory_banner" class="form-control @error('banner') is-invalid @enderror" wire:model="banner">
