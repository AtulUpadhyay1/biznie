                            ...
                            <table class="custom-table borderless-table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><b>Identity Proof:</b><span class="ms-2"><img src="{{ $data->getSellerKycDetail ? imageUrl($data->getSellerKycDetail->identity_proof) : '' }}" alt="Identity Proof"> </span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><b>Business Registration Certificate:</b><span class="ms-2"><img src="{{ $data->getSellerKycDetail ? imageUrl($data->getSellerKycDetail->business_registration_certificate) : '' }}" alt="Business Registration Certificate"> </span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3"><b>Trademark Registration Proof:</b><span class="ms-2"><img src="{{ $data->getSellerKycDetail ? imageUrl($data->getSellerKycDetail->trademark_registration_proof) : '' }}" alt="Trademark Registration Proof"> </span></td>
                                    </tr>
                                    <tr>
