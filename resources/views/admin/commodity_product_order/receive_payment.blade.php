                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-7 text-end">
                            <a href="{{route('admin.commodity-product-order.receive-payment', $data->id)}}" class="btn btn-primary btn-sm" title="Receive Paymet" wire:navigate>
                                Receive Paymet
                            </a>
                            ...
                            <a href="{{route('admin.commodity-product-order.index')}}" class="btn btn-danger btn-sm btn-icon-text float-end align-items-center" wire:navigate>
