                    ...
                    <form wire:submit.prevent="{{$hidden_id ? 'update()' : 'save()'}}">
                        <div class="row mb-3">
                            <div class="col-md-8 border-end">
                                <div class="row">
                                    <h5 class="card-heading-h5">Seller Details:</h5>
                            ...
                            <div class="col-md-4 border-start">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label" for="seller_thumbnail">Thumbnail Image</label>
                                        <input type='file' id="seller_thumbnail" class="form-control @error('thumbnail') is-invalid @enderror" wire:model.defer="thumbnail">
                                        <label for="seller_thumbnail">
                                            @if($thumbnail)
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label" for="seller_banner">Banner Image</label>
                                        <input type='file' id="seller_banner" class="form-control @error('banner') is-invalid @enderror" wire:model.defer="banner">
                                        <label for="seller_banner">
                                            @if($banner)
