                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <a class="btn btn-danger btn-sm btn-icon-text float-end align-items-center" title="Cancel"
                                href="{{ route('admin.seller-type') }}" wire:navigate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type='text' id="title"
                                            ...
                                            wire:model.defer='meta_title' placeholder="Enter title">
                                        @error('meta_title')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type='text' id="keyword"
                                            ...
                                            wire:model.defer='meta_keywords' placeholder="Enter keywords">
                                        @error('meta_keywords')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-md-4 border-start">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type='file' id="seller_thumbnail"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type='file' id="seller_banner"
