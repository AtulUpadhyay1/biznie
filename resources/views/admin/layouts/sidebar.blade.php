...
<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <!--Transporter-->
            <li class="nav-item {{ isActiveRoute(['admin.transporter.index', 'admin.transporter.create', 'admin.transporter.edit', 'admin.transporter.vehicle', 'admin.transporter.product', 'admin.transporter.addressPrice', 'admin.transporter.profile']) ? 'active' : '' }}">
            ...
            <div class="collapse {{ isActiveRoute(['admin.transporter.index', 'admin.transporter.create', 'admin.transporter.edit', 'admin.transporter.vehicle', 'admin.transporter.product', 'admin.transporter.addressPrice', 'admin.transporter.profile']) ? 'show' : '' }}" id="vehicle">
                <ul class="nav sub-menu">
                    <li class="nav-item {{ isActiveRoute(['admin.transporter.index', 'admin.transporter.create', 'admin.transporter.edit', 'admin.transporter.vehicle', 'admin.transporter.product', 'admin.transporter.addressPrice', 'admin.transporter.profile']) ? 'active' : '' }}">
