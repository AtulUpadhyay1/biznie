...
<script src="{{asset('admin/assets/vendors/easymde/easymde.min.js')}}"></script>
<script src="{{asset('admin/assets/js/easymde.js')}}"></script>
...
<script>
    $('.deleteBtn').click(function(event) {
        ...
        swalWithBootstrapButtons.fire({
            title: "{{trans('lang.are_you_confirm')}}",
            text: "{{trans('lang.not_able_to_revert')}}",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonText: "{{trans('lang.yes_delete')}}",
            cancelButtonText: "{{trans('lang.no_cancel')}}",
            reverseButtons: true
        }).then((result) => {
            if (result.value) {
                form.submit();
