                ...
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="bz-toolbar">
                        <a class="btn btn-secondary btn-sm" title="Cancel"
                            href="{{ route('admin.product-sub-category') }}" wire:navigate>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4 border-start">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label class="form-label" for="product_subcategory_thumbnail">Thumbnail Image
                                            <span class="text-danger">*</span></label>
                                        <input type='file' id="product_subcategory_thumbnail"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label class="form-label" for="product_subcategory_banner">Banner Image <span
                                                class="text-danger">*</span></label>
                                        <input type='file' id="product_subcategory_banner"
