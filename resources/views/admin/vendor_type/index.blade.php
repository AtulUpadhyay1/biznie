                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-end">
                                <a class="btn btn-danger btn-icon-text float-end align-items-center" wire:click="create()"><i
                                        class="bi bi-plus-lg me-1"></i>Add Vendor Type</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($list as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a type="button" id="actionEditBtn_{{$data->id}}" data-bs-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">
                                                    <i class="bi bi-three-dots-vertical icon-lg text-muted pb-3px"></i>
                                                </a>
                                                <div class="dropdown-menu" aria-labelledby="actionEditBtn_{{$data->id}}">
