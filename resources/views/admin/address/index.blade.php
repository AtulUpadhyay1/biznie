                ...
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="bz-toolbar">
                        <form class="custom-search-bar">
                            <label class="bz-filter-label" for="address_search">Search addresses</label>
                            <div class="input-group">
                                <span class="input-group-text"> <i class="bi bi-search"></i></span>
                                <input type="text" id="address_search" class="form-control" placeholder="Search here..." wire:model.live="search">
                            </div>
                        </form>
                        <a type="button" class="btn btn-danger btn-sm" title="add" href="{{route('admin.address.create')}}" wire:navigate>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="ActionBtn_{{$data->id}}">
                                                <a href="{{route('admin.address.edit', $data->id)}}"
