                ...
                <div class="container">
                    ...
                    <div class="login-content">
                        <div>
                            ...
                            <form class="admin-login-form forms-sample" method="POST" action="{{ route('seller.phone.login') }}">
                                @csrf
                                <div class="input-area one">
                                    ...
                                    <div class="input-text-area">
                                        <input type="number" class="input @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone') }}" placeholder="Enter phone number">
                                    </div>
                                </div>
                                @error('phone')
