...
<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <!--Sellers-->
            <li class="nav-item {{ isActiveRoute(['seller.product.index', 'seller.commodity-product.index']) ? 'active' : '' }}">
            ...
            <div class="collapse {{ isActiveRoute(['seller.product.index', 'seller.commodity-product.index']) ? 'show' : '' }}" id="product">
                <ul class="nav sub-menu">
                    ...
                    <li class="nav-item {{ isActiveRoute(['seller.commodity-product.index']) ? 'active' : '' }}">
                        <a href="{{route('seller.commodity-product.index')}}" class="nav-link">
                           Add Product
                        </a>
                    </li>
                </ul>
