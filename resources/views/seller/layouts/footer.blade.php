<script src="{{asset('seller_css/assets/vendors/flatpickr/flatpickr.min.js')}}"></script>
<script src="{{asset('seller_css/assets/vendors/apexcharts/apexcharts.min.js')}}"></script>
<script src="{{asset('seller_css/assets/vendors/feather-icons/feather.min.js')}}"></script>
<script src="{{asset('seller_css/assets/js/template.js')}}"></script>
...
<script src="{{asset('seller_css/assets/vendors/jquery-tags-input/jquery.tagsinput.min.js')}}"></script>
<script src="{{asset('seller_css/assets/js/tags-input.js')}}"></script>
<script>
