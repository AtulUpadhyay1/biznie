...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('seller_css/assets/images/favicon.png')}}">
    ...
    <meta name="keywords"
        content="Biznie, bootstrap, bootstrap 5, bootstrap5, seller_css, dashboard, template, responsive, css, sass, html, theme, front-end, ui kit, web">
    ...
    <link rel="stylesheet" href="{{asset('seller_css/assets/vendors/flatpickr/flatpickr.min.css')}}">
    <link rel="stylesheet" href="{{asset('seller_css/assets/fonts/feather-font/css/iconfont.css')}}">
    <link rel="stylesheet" href="{{asset('seller_css/assets/vendors/flag-icon-css/css/flag-icon.min.css')}}">
