...
Route::group(['as'=>'admin.'], function () {
    ...
    Route::group(['middleware' => 'auth:admin'], function () {
        ...
        Route::get('seller-product-request/create/{user_id}', AdminRoot\SellerProductRequest\Create::class)->name('seller-product-request.create');
        ...
        Route::get('seller-product/{user_id}/show/{product_id}', AdminRoot\SellerProduct\Show::class)->name('seller-product.show');
        ...
        Route::get('commodity-product-order/transporter-ledger/{id}', AdminRoot\CommodityProductOrder\TransporterLedger::class)->name('commodity-product-order.transporterLedger');
