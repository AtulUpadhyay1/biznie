...
Route::group(['namespace' => 'App\Http\Controllers\Api'], function () {
    ...
    Route::get('ingot-price-history', 'HomeApiController@ingotPriceHistory');

    // Contact Us
    Route::post('contact-us', 'HomeApiController@contactUs');
    ...
    Route::group(['middleware' => ['auth:sanctum']], function () {
        ...
        // Bookmark
        Route::get('bookmark', 'ProductApiController@bookmarkList');
        ...
        Route::get('credit-wallet-document-type', 'CreditWalletApiController@creditWalletDocument');
