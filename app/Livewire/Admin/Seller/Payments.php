...
class Payments extends Component
{
    ...
    public function addCashWalletBalanace()
    {
        ...
        return $this->redirectRoute('admin.seller.payments', ['id' => $this->data->id, 'mode' => $this->mode], navigate: true);
    }
    ...
    public function addCreditWalletBalanace()
    {
        ...
        return $this->redirectRoute('admin.seller.payments', ['id' => $this->data->id, 'mode' => 'creditwallet'], navigate: true);
    }
}
